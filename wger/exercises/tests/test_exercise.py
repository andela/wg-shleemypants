...
class ExerciseIndexTestCase(WorkoutManagerTestCase):
    ...
    def test_exercise_index_non_editor(self):
        '''
        Tests the exercise overview page
        as a logged in user without editor rights
        '''
...
class ExercisesTestCase(WorkoutManagerTestCase):
    ...
    def add_exercise_user_fail(self):
        ...
        exercises by users that aren't authorized
        '''
    ...
    def add_exercise_success(self, admin=False):
        ...
        self.assertEqual(
            count_before + 1, count_after, 'Exercise was not added')
    ...
    def search_exercise(self, fail=True):
        ...
        self.assertEqual(
            result['suggestions'][0]['value'], 'Very cool exercise')
        self.assertEqual(result['suggestions'][0]['data']['id'], 2)
        self.assertEqual(
            result['suggestions'][0]['data']['category'], 'Another category')
