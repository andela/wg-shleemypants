...
def delete(request, user_pk=None):
    ...
    if user_pk:
        ...
        if not request.user.has_perm('gym.manage_gyms') \
                and (not req_usr.has_perm('gym.manage_gym')
                     or req_usr.userprofile.gym_id != user.userprofile.gym_id
...
class UserDeactivateView(LoginRequiredMixin,
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(UserDeactivateView, self).dispatch(request,
                                                        *args, **kwargs)
...
class UserActivateView(LoginRequiredMixin,
    ...
    permission_required = ('gym.manage_gym',
                           'gym.manage_gyms', 'gym.gym_trainer')
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(UserActivateView, self).dispatch(request,
                                                      *args, **kwargs)
